...
import com.elusivehawk.engine.physics.jbullet.collision.dispatch.SimulationIslandManager;
...
import com.elusivehawk.engine.physics.jbullet.dynamics.constraintsolver.SequentialImpulseConstraintSolver;
...
import com.elusivehawk.engine.physics.jbullet.linearmath.DebugDrawModes;
		...
		if (getDebugDrawer() != null && (getDebugDrawer().getDebugMode() & (DebugDrawModes.DRAW_WIREFRAME | DebugDrawModes.DRAW_AABB)) != 0) {
			...
			for (i = 0; i < vehicles.size(); i++) {
				for (int v = 0; v < vehicles.getQuick(i).getNumWheels(); v++) {
					...
					axle.set(
							vehicles.getQuick(i).getWheelInfo(v).worldTransform.basis.get(0, vehicles.getQuick(i).getRightAxis()),
							vehicles.getQuick(i).getWheelInfo(v).worldTransform.basis.get(1, vehicles.getQuick(i).getRightAxis()),
							vehicles.getQuick(i).getWheelInfo(v).worldTransform.basis.get(2, vehicles.getQuick(i).getRightAxis()));
