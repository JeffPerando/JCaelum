...
class BvhTree
{
	...
	protected int _calc_splitting_axis(BvhDataArray primitive_boxes,
	...
	protected int _sort_and_calc_splitting_index(BvhDataArray primitive_boxes,
			int startIndex, int endIndex, int splitAxis)
	{
		...
		boolean unbal = (splitIndex == startIndex)
				|| (splitIndex == (endIndex));
		assert (!unbal);
	...
	protected void _build_sub_tree(BvhDataArray primitive_boxes,
			int startIndex, int endIndex)
	{
		...
		// split axis
		int splitIndex = _calc_splitting_axis(primitive_boxes, startIndex,
				endIndex);
		
		splitIndex = _sort_and_calc_splitting_index(primitive_boxes,
				startIndex, endIndex, splitIndex);
