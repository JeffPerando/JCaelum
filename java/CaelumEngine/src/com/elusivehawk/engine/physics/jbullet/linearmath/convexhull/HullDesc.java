...
public class HullDesc
{
	...
	/** Array of vertices. */
	public ObjectArrayList<Vector> vertices;
	...
	public HullDesc(int flag, int vcount, ObjectArrayList<Vector> vertices) {
		this(flag, vcount, vertices, 3*4);
	}
	
	public HullDesc(int flag, int vcount, ObjectArrayList<Vector> vertices, int stride)
	{
		this.flags = flag;
		this.vcount = vcount;
