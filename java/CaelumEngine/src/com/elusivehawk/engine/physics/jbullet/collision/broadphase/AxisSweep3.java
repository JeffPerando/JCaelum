 ...
 * <p>
 * 
 * It uses arrays rather then lists for storage of the 3 axis. Also it operates using 16 bit integer coordinates instead of floats. For large worlds and many objects, use {@link AxisSweep3_32} instead. AxisSweep3_32 has higher precision and allows more than 16384 objects at the cost of more memory and bit of performance.
 * 
 * @author jezek2
 */
public class AxisSweep3 extends AxisSweep3Internal
{
	public AxisSweep3(Vector worldAabbMin, Vector worldAabbMax)
	{
		this(worldAabbMin, worldAabbMax, 16384, null);
		
	}
	
	public AxisSweep3(Vector worldAabbMin, Vector worldAabbMax, int maxHandles)
	{
	...
	public AxisSweep3(Vector worldAabbMin, Vector worldAabbMax,
			int maxHandles/* = 16384 */, OverlappingPairCache pairCache/* = 0 */)
	{
	...
	{
		private short[] minEdges = new short[3];
		private short[] maxEdges = new short[3];
		
		@Override
		public int getMinEdges(int edgeIndex)
		{
			return this.minEdges[edgeIndex] & 0xFFFF;
		}
		
		@Override
		public void setMinEdges(int edgeIndex, int value)
		{
			this.minEdges[edgeIndex] = (short)value;
		...
		{
			return this.maxEdges[edgeIndex] & 0xFFFF;
		}
		
		@Override
		public void setMaxEdges(int edgeIndex, int value)
		{
			this.maxEdges[edgeIndex] = (short)value;
